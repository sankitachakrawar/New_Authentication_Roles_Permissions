...
public interface UserRepository extends JpaRepository<UserEntity, Long> {
	...
	public Page<IUserDto> findByNameContainingIgnoreCaseOrderById(String search, Pageable paging,
			Class<IUserDto> class1);
	...
	Optional<UserCount> findById(UserEntity id);
